        ...
        <section className="py-24 bg-slate-950 relative overflow-hidden">
            <div className="container px-4 mx-auto">
                <div className="text-center mb-16">
                    <h2 className="text-3xl md:text-5xl font-bold text-white mb-4">Universal Compatibility</h2>
                    <p className="text-slate-400 max-w-xl mx-auto">
                        Seamlessly ingest data from any major pathology instrument. Our agnostic architecture unifies your lab's workflow.
                    </p>
                </div>
             ...
             */}
                    ...
                    <div className="h-full flex items-center">
                        <div className="glass-panel w-full h-[80%] flex flex-col justify-center items-center p-8 border-fuchsia-500/50 shadow-[0_0_40px_rgba(217,70,239,0.15)] rounded-2xl relative">
                            ...
                            <h3 className="text-2xl font-bold text-white mb-2">Stellar Infomatica Core</h3>
                            <p className="text-sm text-fuchsia-200/60 text-center">
                                Centralized Processing Unit <br /> v2.4.0 (Stable)
                            </p>
                        </div>
                    </div>
                ...
                <div className="md:hidden flex flex-col gap-8">
                    ...
                    <div className="glass-panel p-8 text-center border-fuchsia-500/50 rounded-xl">
                        ...
                        <h3 className="text-xl font-bold text-white">Stellar Infomatica Core</h3>
                    </div>
                </div>
